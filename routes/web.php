...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('tokens')->group(function () {
        Route::get('', [TokenController::class, 'index'])->name('user.tokens');
        Route::post('', [TokenController::class, 'store'])->name('user.tokens.store');
        Route::delete('{id}', [TokenController::class, 'destroy'])->name('user.tokens.destroy');
    });

    Route::prefix('ai')->group(function () {
        Route::get('', [AiController::class, 'index'])->name('ai');
        Route::post('process', [AiController::class, 'process'])->name('ai.process');
        Route::post('process-download', [AiController::class, 'processAndDownload'])->name('ai.process.download');
        Route::get('config', [AiController::class, 'config'])->name('ai.config');
        Route::post('config', [AiController::class, 'saveConfig'])->name('ai.config.save');
        Route::get('health', [AiController::class, 'health'])->name('ai.health');
    });
    Route::group([
        'prefix' => 'api',
        'middleware' => CheckIsEnableApi::class
    ], function () {
        Route::match(['get', 'post'], '', [ApiController::class, 'index'])->name('api');
    });
    ...
    Route::group(['prefix' => 'user'], function () {
        ...
        Route::put('images/{id}/edit', [ImageController::class, 'edit'])->name('user.images.edit');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth.admin']], function () {
    ...
    Route::group(['prefix' => 'directory-import'], function () {
        Route::get('', [\App\Http\Controllers\Admin\DirectoryImportController::class, 'index'])->name('admin.directory-import');
        Route::post('scan', [\App\Http\Controllers\Admin\DirectoryImportController::class, 'scan'])->name('admin.directory-import.scan');
        Route::post('import', [\App\Http\Controllers\Admin\DirectoryImportController::class, 'import'])->name('admin.directory-import.import');
    });
});
