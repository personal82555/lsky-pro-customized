        ...
        <div>
            ...
            <div class="flex flex-col space-y-2 mb-12">
                ...
                <x-nav-link :href="route('user.tokens')" :active="request()->routeIs('user.tokens')">
                    <x-slot name="icon"><i class="fas fa-key text-blue-500"></i></x-slot>
                    <x-slot name="name">我的 Token</x-slot>
                </x-nav-link>
                <x-nav-link :href="route('ai')" :active="request()->routeIs('ai')">
                    <x-slot name="icon"><i class="fas fa-magic text-purple-500"></i></x-slot>
                    <x-slot name="name">AI 图片处理</x-slot>
                </x-nav-link>
            </div>
            ...
            <div class="flex flex-col space-y-2 mb-12">
                ...
                <x-nav-link :href="route('admin.directory-import')" :active="request()->is('admin/directory-import*')">
                    <x-slot name="icon"><i class="fas fa-folder-open text-blue-500"></i></x-slot>
                    <x-slot name="name">目录导入</x-slot>
                </x-nav-link>
                ...
                <x-nav-link :href="route('ai.config')" :active="request()->routeIs('ai.config')">
                    <x-slot name="icon"><i class="fas fa-brain text-indigo-500"></i></x-slot>
                    <x-slot name="name">AI 超能配置</x-slot>
                </x-nav-link>
            </div>
            @endif
        </div>
